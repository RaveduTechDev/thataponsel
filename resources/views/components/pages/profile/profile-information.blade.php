...
@section('content')
        ...
        <div class="col-md-8">
            <div class="card p-4">
                <form action="{{ route('profile.upload', ['user' => Auth::user()->username]) }}" method="post"
                    enctype="multipart/form-data" class="formProfile">
            ...
            <div class="card p-4">
                <form id="formSubmit" action="{{ route('user-profile-information.update') }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-8">
            <div class="card p-4">
                <form action="{{ route('user-password.update') }}" method="post" class="formProfile">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const forms = document.querySelectorAll('.formProfile');
