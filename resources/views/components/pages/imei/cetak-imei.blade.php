        ...
        @foreach ($data as $pelangganId => $jasa_imeis)
            ...
            <div class="invoice-header">
                ...
                <div class="contact-info">
                    ...
                    <p>Tanggal:
                        <strong>{{ \Carbon\Carbon::parse($first->tanggal)->isoFormat('D MMMM YYYY') }}</strong>
                    </p>
                </div>
            </div>
            ...
            <div class="items">
                <table>
                    ...
                    <tbody>
                        @foreach ($jasa_imeis as $i => $item)
                            <tr>
                                <td style="white-space: nowrap;">{{ $i + 1 }}</td>
                                <td>{{ $item->imei ?? '-' }}</td>
                                <td style="white-space: nowrap;">{{ $item->tipe ?? '-' }}</td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3" class="total-label" style="font-weight: bold; text-align:left;">
                                Total:
                            </td>
